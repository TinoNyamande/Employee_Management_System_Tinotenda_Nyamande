...
@Component({
  selector: 'app-viewperformances',
  templateUrl: './viewperformances.component.html',
  styleUrls: ['./viewperformances.component.css']
})
export class ViewperformancesComponent {
  ...
  ngOnInit(): void {
    ...
    this.api.getPerformances(this.email)
    .subscribe({
      next:(res)=>{
     //alert(res.message);
     //console.log(res)
